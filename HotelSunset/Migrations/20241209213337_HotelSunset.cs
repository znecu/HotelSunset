...
{
    /// <inheritdoc />
    public partial class HotelSunset : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HabitacionDetalle_Agregados_AgregadoId",
                        column: x => x.AgregadoId,
                        principalTable: "Agregados",
                        principalColumn: "AgregadoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HabitacionDetalle_Habitaciones_HabitacionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservasDetalle_ArticulosExtras_ExtrasId",
                        column: x => x.ExtrasId,
                        principalTable: "ArticulosExtras",
                        principalColumn: "ExtrasId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservasDetalle_Reservas_ReservaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HabitacionDetalle_AgregadoId",
                table: "HabitacionDetalle",
                column: "AgregadoId");

            migrationBuilder.CreateIndex(
                name: "IX_HabitacionDetalle_HabitacionId",
                table: "HabitacionDetalle",
                column: "HabitacionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservasDetalle_ExtrasId",
                table: "ReservasDetalle",
                column: "ExtrasId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservasDetalle_ReservaId",
                table: "ReservasDetalle",
                column: "ReservaId");
        }
